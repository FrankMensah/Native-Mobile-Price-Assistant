...
class BarcodeEdit extends StatefulWidget {
  Map<dynamic, dynamic> productObjects;
  BarcodeEdit(this.productObjects);

  @override
  State<BarcodeEdit> createState() => _BarcodeEditState();
}

class _BarcodeEditState extends State<BarcodeEdit> {
  @override
  Widget build(BuildContext context) {
    int? postid = widget.productObjects["id"];
    String postcode = widget.productObjects["productCode"].toString();
    String postProduct = widget.productObjects["productName"].toString();
    String postAmount = widget.productObjects["productAmount"].toString();
